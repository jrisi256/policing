---
title: "Merge Uses of Force to Shift Assignments"
format: pdf
---
...
### Uses of Force
1. **civ.race**: I combine Asian American/Pacific Islanders and Native Americans/Alaskan Natives into their own category.
2. I drop the **civilian_race_short** column.
3. I rename **civ.gender** to **civ.sex**.
...
force <-
    ...
    mutate(civ.race = fct_recode(civ.race,
                                 ...
                                 aapi_native = "NATIVE AMERICAN/ALASKAN NATIVE")) %>%
...
pretty_print_force <- PrettyPrint(force_merged, force, officer_assignments,
                                  ...
                                  "force_id")
write_csv(force_merged, here(out_path, "force_officers_assignments_risi_max.csv"))
```
...
# Write out results
write_csv(force_shift_assignments, here(out_path, "force_officers_assignments_risi_min.csv"))
```
