...
ggplot(variation_officer_race, aes(x = shift_id, y = prcnt)) +
    ...
    labs(
        x = "Shift assignment",
        y = "Percent of shift assignment worked by officers of a particular race"
    ) +
...
variation_within_shift_by_all <-
    ...
    select(unit_beat_id, shift, officer_race, prcnt)
...
ggplot(variation_within_shift_by_race, aes(x = officer_race, y = prcnt)) +
    geom_bar(position = "fill", stat = "identity", aes(fill = shift)) +
    theme_bw() +
