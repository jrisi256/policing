---
title: "Merge Arrests to Shift Assignments"
format: pdf
---
...
2. **civ.race**: I combine Asian American/Pacific Islanders and Native Americans/Alaskan Natives into an their own category.
3. I drop the **civilian_race_short** column.
4. I rename **civ.gender** to **civ.sex**.
...
pretty_print_arrests <- PrettyPrint(arrests_merged, arrests, officer_assignments,
                                    ...
                                    "arrest_officer_id")
write_csv(arrests_merged, here(out_path, "arrests_officers_assignments_risi_max.csv"))
```
...
# Write out results
write_csv(arrests_shift_assignments, here(out_path, "arrests_officers_assignments_risi_min.csv"))
```
