---
title: "Replicate Ba et al. 2021 - Merge Stops to Shift Assignments"
format: pdf
---
...
pretty_print_stops <- PrettyPrint(stops_merged, stops, officer_assignments,
                                  ...
                                  "stop_officer_id")
write_csv(stops_merged, here(out_path, "stops_officers_assignments_ba_max.csv"))
```
...
# Write out results
write_csv(stops_shift_assignments, here(out_path, "stops_officers_assignments_ba_min.csv"))
```
