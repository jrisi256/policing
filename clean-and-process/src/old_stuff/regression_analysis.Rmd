...
fixest_cluster_nb_t10 <-
    femlm(black_stops ~ black_ratio + mean_years_exp + percent10 +
...
fixest_cluster_nb_t15 <-
    femlm(black_stops ~ black_ratio + mean_years_exp + percent15 +
              violent_cr_capita + property_cr_capita + log_total_officers +
              year + offset(log(black)) | unit,
          family = "negbin",
          data = final_vars)
...
fixest_cluster_nb_t20 <-
    femlm(black_stops ~ black_ratio + mean_years_exp + percent20 +
              violent_cr_capita + property_cr_capita + log_total_officers +
              year + offset(log(black)) | unit,
          family = "negbin",
          data = final_vars)
...
fixest_cluster_nb_t25 <-
    femlm(black_stops ~ black_ratio + mean_years_exp + percent25 +
              violent_cr_capita + property_cr_capita + log_total_officers +
              year + offset(log(black)) | unit,
          family = "negbin",
          data = final_vars)
...
fixest_cluster_nb_t30 <-
    femlm(black_stops ~ black_ratio + mean_years_exp + percent30 +
              violent_cr_capita + property_cr_capita + log_total_officers +
              year + offset(log(black)) | unit,
          family = "negbin",
          data = final_vars)
...
=======
>>>>>>> 794d4896215281b1c6822f3253f476630411a92c
```{r, results = "asis"}
