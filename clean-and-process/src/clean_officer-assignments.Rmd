...
write_csv(officer_assignments, here(write_path, "officer_assignments_risi.csv"))
...
nr_stops_removed <-
    stops %>%
    filter(!(officer_id %in% officer_assignments_ba$officer_id)) %>%
    nrow()
...
### Number of Stops, Arrests, and Uses of Force Removed

These are the number of stops, arrests, and uses of force removed due to the race and rank filtering.

* Number of stops removed: `r nr_stops_removed`
    * Percentage of stops removed: `r nr_stops_removed / nrow(stops) * 100`%
* Number of arrests removed: `r nr_arrests_removed`
    * Percentage of arrests removed: `r nr_arrests_removed / nrow(arrests) * 100`%
* Number of uses of force removed: `r nr_force_removed`
    * Percentage of uses of force removed: `r nr_force_removed / nrow(force) * 100`%
